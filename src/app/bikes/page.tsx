...
export const metadata: Metadata = {
  title: `New bikes & two-wheelers — on-road price in plain English`,
  description: `Browse cruisers, commuters and electric scooters on ${siteConfig.name}. Priced the same honest way as the cars.`,
};

export default async function BikesIndexPage({
  searchParams,
}: {
  ...
  return (
    <SelectedVehicleProvider vehicles={vehicles}>
      ...
      <main id="main" className="flex-1">
        <CatalogueBrowse vehicles={vehicles} segment="BIKE" query={query} />
      </main>
      <Footer />
